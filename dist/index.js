...
var RenderIndex = /** @class */ (function () {
    function RenderIndex() {
        ...
        this.setClasses = function () {
            ...
            _this.heading.textContent = "Avisos!";
            _this.heading.className = "text-slate-700 text-2xl bold mb-5";
            _this.nav.className = "relativew-fullflex flex-wrap items-center justify-between bg-blue-600 py-4 text-yellow-50 hover:text-gray-700 focus:text-gray-700 shadow-lg navbar navbar-expand-lg navbar-light";
            _this.section.className = "block mx-auto h-fit w-4/6 mt-10 mb-10";
        };
        this.setInnerHTML = function () {
            ...
            _this.article.innerHTML = "\n    <style>\n    p a {font-weight: bold;} \n    li a {font-weight: bold;}\n    </style>\n      <h3>".concat(_this.avisos[0].Title1, "</h3>\n      <p>").concat(_this.avisos[0].Text1, "</p>\n    \n      <h3 class=\"mt-5\">").concat(_this.avisos[1].Title2, "</h3>\n      <p>").concat(_this.avisos[1].Text2, "</p>\n    \n      <h3 class=\"mt-5\">").concat(_this.avisos[2].Title3, "</h3>\n      <p>").concat(_this.avisos[2].Text3, "</p>\n    \n      <h3 class=\"mt-5\">").concat(_this.avisos[3].Title4, "</h3>\n      <p class=\"mb-5\">").concat(_this.avisos[3].Text4, "</p>\n    ");
        ...
        this.appendElements = function () {
            ...
            _this.section.appendChild(_this.heading);
            _this.section.appendChild(_this.article);
            _this.body.appendChild(_this.section);
            _this.section.after(_this.footer);
        };
        this.setListeners = function () {
            _this.buttons.buttonEstudante.onmouseover = function () { return _this.menu.menuEstudante.style.display = "block"; };
            _this.buttons.buttonEstudante.onmouseleave = function () { return _this.menu.menuEstudante.style.display = "none"; };
            _this.buttons.buttonDocente.onmouseover = function () { return _this.menu.menuDocente.style.display = "block"; };
            _this.buttons.buttonDocente.onmouseleave = function () { return _this.menu.menuDocente.style.display = "none"; };
            _this.buttons.buttonSecretaria.onmouseover = function () { return _this.menu.menuSecretaria.style.display = "block"; };
        ...
        this.avisos = [
            {
                Title1: (_a = this.arrInfo[0].querySelector('div[class="title"]')) === null || _a === void 0 ? void 0 : _a.innerHTML,
                Text1: (_b = this.arrInfo[0].querySelector('div[class="text"]')) === null || _b === void 0 ? void 0 : _b.innerHTML
            },
            {
                Title2: (_c = this.arrInfo[1].querySelector('div[class="title"]')) === null || _c === void 0 ? void 0 : _c.innerHTML,
                Text2: (_d = this.arrInfo[1].querySelector('div[class="text"]')) === null || _d === void 0 ? void 0 : _d.innerHTML
            },
            {
                Title3: (_e = this.arrInfo[2].querySelector('div[class="title"]')) === null || _e === void 0 ? void 0 : _e.innerHTML,
                Text3: (_f = this.arrInfo[2].querySelector('div[class="text"]')) === null || _f === void 0 ? void 0 : _f.innerHTML
            },
            {
                Title4: (_g = this.arrInfo[3].querySelector('div[class="title"]')) === null || _g === void 0 ? void 0 : _g.innerHTML,
                Text4: (_h = this.arrInfo[3].querySelector('div[class="text"]')) === null || _h === void 0 ? void 0 : _h.innerHTML
            }
        ];
        this.deleteBody();
        this.setClasses();
        ...
        this.appendElements();
        this.buttons = {
            buttonEstudante: this.nav.querySelector('li[name="estudante"]'),
            buttonDocente: this.nav.querySelector('li[name="docente"]'),
            buttonSecretaria: this.nav.querySelector('li[name="secretaria"]')
        };
        this.menu = {
            menuEstudante: this.nav.querySelector('div[name="listEstudante"]'),
            menuDocente: this.nav.querySelector('div[name="listDocente"]'),
            menuSecretaria: this.nav.querySelector('div[name="listSecretaria"]'),
        };
        this.setListeners();
    }
    return RenderIndex;
...
//NAV
nav.className = `relativew-fullflex flex-wrap items-center justify-between py-4 text-yellow-50 hover:text-gray-700 focus:text-gray-700 shadow-lg navbar navbar-expand-lg navbar-light`;
nav.innerHTML = `
...
const Avisos = [
{
  Title1: arrInfo[0].querySelector('div[class="title"]')?.innerHTML as string,
  Text1: arrInfo[0].querySelector('div[class="text"]')?.innerHTML as string
},

{
  Title2: arrInfo[1].querySelector('div[class="title"]')?.innerHTML as string,
  Text2: arrInfo[1].querySelector('div[class="text"]')?.innerHTML as string
},

{
  Title3: arrInfo[2].querySelector('div[class="title"]')?.innerHTML as string,
  Text3: arrInfo[2].querySelector('div[class="text"]')?.innerHTML as string
},

{
  Title4: arrInfo[3].querySelector('div[class="title"]')?.innerHTML as string,
  Text4: arrInfo[3].querySelector('div[class="text"]')?.innerHTML as string
}
];
